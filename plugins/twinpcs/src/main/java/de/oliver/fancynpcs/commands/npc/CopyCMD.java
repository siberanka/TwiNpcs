...
public enum CopyCMD {
    ...
    @Permission("twinpcs.command.npc.copy")
    public void onCopy(
        ...
        copied.getData().setModel(npc.getData().getModelProvider(), npc.getData().getModelId());
        copied.getData().setBedrockFallbackType(npc.getData().getBedrockFallbackType());
        copied.getData().setBedrockOffset(
                npc.getData().getBedrockOffsetX(),
                npc.getData().getBedrockOffsetY(),
                npc.getData().getBedrockOffsetZ()
        );
        copied.getData().setBedrockInteractionForwarding(npc.getData().isBedrockInteractionForwarding());
        copied.getData().setBedrockSkinData(npc.getData().getBedrockSkinData());
        copied.getData().setBedrockMirrorSkin(npc.getData().isBedrockMirrorSkin());
