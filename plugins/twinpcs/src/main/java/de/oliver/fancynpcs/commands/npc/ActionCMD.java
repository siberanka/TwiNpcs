...
public enum ActionCMD {
    ...
    @Permission("twinpcs.command.npc.action.add")
    ...
    @Permission("twinpcs.command.npc.action.addBefore")
    ...
    @Permission("twinpcs.command.npc.action.addAfter")
    ...
    @Permission("twinpcs.command.npc.action.set")
    ...
    @Permission("twinpcs.command.npc.action.remove")
    ...
    @Permission("twinpcs.command.npc.action.moveUp")
    ...
    @Permission("twinpcs.command.npc.action.moveDown")
    ...
    @Permission("twinpcs.command.npc.action.clear")
    ...
    @Permission("twinpcs.command.npc.action.list")
    ...
    private boolean checkAddPermissions(final CommandSender sender, final NpcAction action) {
        boolean hasGeneralPerms = sender.hasPermission("twinpcs.command.npc.action.add.*");
        boolean hasSpecificPerms = sender.hasPermission("twinpcs.command.npc.action.add." + action.getName());
