...
public final class FancyNpcsCMD {
    ...
    @Command("twinpcs version")
    @Permission("twinpcs.command.twinpcs.version")
    public void onVersion(final CommandSender sender) {
        plugin.getVersionConfig().checkVersionAndDisplay(sender, false);
    }

    @Command("twinpcs reload")
    @Permission("twinpcs.command.twinpcs.reload")
    ...
    @Command("twinpcs save")
    @Permission("twinpcs.command.twinpcs.save")
    ...
    @Command("twinpcs feature_flags")
    @Permission("twinpcs.command.twinpcs.feature_flags")
